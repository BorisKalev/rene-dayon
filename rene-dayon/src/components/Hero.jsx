  ...
  return (
    <section className="relative min-h-screen bg-zinc-950 overflow-hidden flex flex-col">
      ...
      >
        ...
        <div
          ...
          style={{
            width: "340px",
            background:
              "linear-gradient(to right, #09090b 15%, transparent 100%)",
          }}
        />
        {/* Top fade */}
        <div
        ...
        <div
          ...
          style={{
            height: "220px",
            background:
              "linear-gradient(to top, #09090b 30%, transparent 100%)",
          }}
        />
      ...
      <div className="relative z-10 flex-1 flex flex-col w-full">
        ...
        <div
          className="lg:hidden relative mx-0 overflow-hidden"
          style={{ height: "260px" }}
        >
          <img
            src={redCar}
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to top, #09090b 20%, transparent 65%)",
            }}
          />
          <div
            aria-hidden="true"
            ...
            style={{
              background:
                "linear-gradient(to bottom, #09090b, transparent 40%)",
            }}
          />
        </div>
